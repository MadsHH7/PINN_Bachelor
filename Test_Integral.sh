...
#BSUB -o batch_outputs/Standard_Integral.out
#BSUB -e batch_outputs/Standard_Integral.err
...
cd /zhome/e1/d/168534/Desktop/Bachelor_PINN/PINN_Bachelor/batch_outputs/Standard_With_Integral/
python -u 3D_Pipe.py
