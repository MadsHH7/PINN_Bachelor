...
def run(cfg: ModulusConfig) -> None:
    ...
    input_bend, output_bend, nr_points = get_data(
        df_path= os.path.join(data_path, f"U0{key}_NotUni_1K_Train.csv"),
    ...
    val_df = os.path.join(data_path, f"U0{key}_NotUni_1K_Validation.csv")
    ...
    csv_var = csv_to_dict(
        to_absolute_path(os.path.join(data_path, f"U0{key}_NotUni_1K_Validation.csv")), mapping
    )
