...
#BSUB -o batch_outputs/Standard_Standard.out
#BSUB -e batch_outputs/Standard_Standard.err
...
cd /zhome/e1/d/168534/Desktop/Bachelor_PINN/PINN_Bachelor/batch_outputs/Standard_No_extra/
python -u 3D_Pipe.py
