...
#BSUB -o batch_outputs/Standard_ZE.out
#BSUB -e batch_outputs/Standard_ZE.err
...
cd /zhome/e1/d/168534/Desktop/Bachelor_PINN/PINN_Bachelor/batch_outputs/Standard_With_ZE/
python -u 3D_Pipe.py
